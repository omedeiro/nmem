...
**Image:** <img src="ber_enable_write_sweep_fine.png" alt="plot_ber_enable_write_sweep_min_fine" width="576">
...
**Description:** Script to plot the bit error rate (BER) for read current sweeps at write currents from 0 to 700µA.
