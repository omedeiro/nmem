...
|-----------|------|-----------|------|
| Bit Error Rate | <img src="array_bit_error_rate_matrix.png" alt="Bit Error Rate" width="6in"> | Enable Read Current | <img src="array_enable_read_current_matrix.png" alt="Enable Read Current" width="6in"> |
| Enable Read Power | <img src="array_enable_read_power_matrix.png" alt="Enable Read Power" width="6in"> | Enable Write Current | <img src="array_enable_write_current_matrix.png" alt="Enable Write Current" width="6in"> |
| Enable Write Power | <img src="array_enable_write_power_matrix.png" alt="Enable Write Power" width="6in"> | Max Critical Current | <img src="array_max_critical_current_matrix.png" alt="Max Critical Current" width="6in"> |
| Read Current | <img src="array_read_current_matrix.png" alt="Read Current" width="6in"> | Resistance | <img src="array_resistance_matrix.png" alt="Resistance" width="6in"> |
| Slope | <img src="array_slope_matrix.png" alt="Slope" width="6in"> | Write Current | <img src="array_write_current_matrix.png" alt="Write Current" width="6in"> |
| X Intercept | <img src="array_x_intercept_matrix.png" alt="X Intercept" width="6in"> | Y Intercept | <img src="array_y_intercept_matrix.png" alt="Y Intercept" width="6in"> |
...
**Images:**
- Figure 1: <img src="ber_enable_write_sweep.png" alt="plot_ber_enable_write_sweep_fig1" width="6in">
- Figure 2: <img src="ber_enable_write_sweep_state_current_markers.png" alt="plot_ber_enable_write_sweep_fig2" width="6in">
...
**Image:** <img src="ber_enable_write_sweep_fine.png" alt="plot_ber_enable_write_sweep_fine" width="6in">
...
**Image:** <img src="ber_geom_loop_size.png" alt="plot_ber_geom_loop_size" width="12in">
...
**Image:** <img src="ber_memory_retention.png" alt="plot_ber_memory_retention" width="6in">
...
**Image:** <img src="ber_read_current_sweep_enable_write.png" alt="plot_ber_read_current_sweep_enable_write" width="6in">
...
**Image:** <img src="ber_read_current_sweep_enable_write_trio.png" alt="plot_ber_read_current_sweep_enable_write_trio" width="6in">
...
**Image:** <img src="ber_read_current_sweep_write_current.png" alt="plot_ber_read_current_sweep_write_current" width="6in">
...
**Image:** <img src="ber_read_current_sweep_write_current2.png" alt="plot_ber_read_current_sweep_write_current2" width="12in">
...
**Images:**
- Figure 1: <img src="ber_read_current_sweep_write_current3_part1.png" alt="plot_ber_read_current_sweep_write_current3_fig1" width="6in">
- Figure 2: <img src="ber_read_current_sweep_write_current3_part2.png" alt="plot_ber_read_current_sweep_write_current3_fig2" width="6in">
...
**Image:** <img src="ber_read_current_sweep_write_current_coarse.png" alt="plot_ber_read_current_sweep_write_current_coarse" width="6in">
...
**Image:** <img src="ber_read_current_sweep_write_current_fine.png" alt="plot_ber_read_current_sweep_write_current_fine" width="6in">
...
**Image:** <img src="ber_read_sweep_memory_retention.png" alt="plot_ber_read_sweep_memory_retention" width="6in">
...
**Image:** <img src="ber_vs_read_current_array.png" alt="plot_ber_vs_read_current_array" width="6in">
...
**Image:** <img src="ber_vs_read_current_array_analysis.png" alt="plot_ber_vs_read_current_array_analysis" width="6in">
...
**Image:** <img src="ber_vs_read_current_array_extract.png" alt="plot_ber_vs_read_current_array_extract" width="6in">

---

### plot_ber_vs_read_current_array_probability

**Script:** `plot_ber_vs_read_current_array_probability.py`
...
**Image:** <img src="ber_vs_read_current_array_probability.png" alt="plot_ber_vs_read_current_array_probability" width="6in">
...
**Image:** <img src="ber_write_current_enable_margin_markers.png" alt="plot_ber_write_current_enable_margin_markers" width="6in">
...
**Image:** <img src="ber_write_current_sweep.png" alt="plot_ber_write_current_sweep_enable_write" width="6in">
...
**Image:** <img src="calc_branch_currents.png" alt="plot_calc_branch_currents" width="6in">
...
**Image:** <img src="calc_read_sweep_fitting.png" alt="plot_calc_read_sweep_fitting" width="6in">
...
**Image:** <img src="compare_energy_bar.png" alt="plot_compare_energy_bar" width="6in">
...
**Image:** <img src="compare_metrics_spider.png" alt="plot_compare_metrics_spider" width="6in">
...
**Image:** <img src="compare_size_bar.png" alt="plot_compare_size_bar" width="6in">
...
**Image:** <img src="autoprobe_resistance_matrix.png" alt="plot_fab_autoprobe_resistance_matrix" width="6in">
...
**Image:** <img src="ntron_dose_images.png" alt="plot_fab_ntron_dose_images" width="12in">
...
**Image:** <img src="wafer_thickness_map.png" alt="plot_fab_wafer_thickness_map" width="6in">
...
**Image:** <img src="figure2.png" alt="plot_figure2" width="6in">
...
**Image:** <img src="figure3.png" alt="plot_figure3" width="6in">
...
**Images:**
- Figure 1: <img src="figure4_comprehensive_ber_analysis.png" alt="plot_figure4_fig1" width="4.724409448818898in">
- Figure 2: <img src="figure4_right_panel_ber_analysis.png" alt="plot_figure4_fig2" width="4.724409448818898in">
...
**Image:** <img src="ic_temperature_sweep_array.png" alt="plot_ic_temperature_sweep_array" width="6in">
...
**Images:**
- Figure 1: <img src="iv_temperature_sweep_critical_currents.png" alt="plot_iv_temperature_sweep_fig1" width="6in">
- Figure 2: <img src="iv_temperature_sweep_current_voltage.png" alt="plot_iv_temperature_sweep_fig2" width="6in">
...
**Image:** <img src="voltage_prbs_probe_station_trace.png" alt="plot_voltage_prbs_probe_station_trace" width="6in">
...
**Image:** <img src="voltage_read_histogram.png" alt="plot_voltage_read_histogram" width="6in">
...
**Image:** <img src="voltage_trace_array_emulation.png" alt="plot_voltage_trace_array_emulation" width="12in">
...
**Image:** <img src="voltage_trace_averaged.png" alt="plot_voltage_trace_averaged" width="6in">
...
|------------|----------|
| <img src="voltage_write_current_sweep_off.png" alt="Write Current Sweep OFF" width="6in"> | <img src="voltage_write_current_sweep_on.png" alt="Write Current Sweep ON" width="6in"> |
| <img src="voltage_trace_stack_off.png" alt="Voltage Trace Stack OFF" width="6in"> | <img src="voltage_trace_stack_on.png" alt="Voltage Trace Stack ON" width="6in"> |
