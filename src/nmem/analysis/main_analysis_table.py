...
def generate_analysis_table(save_csv=False, filename="array_parameter_table.csv"):
    """
    Generate a summary table of cell parameters and derived quantities.

    Parameters
    ----------
    save_csv : bool
        If True, save the table as a CSV file.
    filename : str
