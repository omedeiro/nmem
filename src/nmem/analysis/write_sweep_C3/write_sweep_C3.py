...
def plot_write_sweep(ax, data_directory: str):
    ...
    for data in [data_list[-7]]:
        ...
        enable_write_temp = calculate_channel_temperature(SUBSTRATE_TEMP, CRITICAL_TEMP, enable_write_current, max_enable_current).flatten()[0]
        ax.plot(
            y,
            ztotal,
        ...
        ax.hlines(write_Ic, ax.get_xlim()[0], ax.get_xlim()[1], linestyle="--", color="k")
