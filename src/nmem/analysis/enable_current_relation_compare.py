...
def process_cell(cell: dict, param_dict: dict, x: int, y: int):
...
if __name__ == "__main__":
    ...
    for c in CELLS:
        process_cell(CELLS[c], param_dict, *convert_location_to_coordinates(c))

    plot_array(xloc, yloc, param_dict["write_current"], "Write Current [$\mu$A]")
