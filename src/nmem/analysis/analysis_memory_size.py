...
fig.suptitle("Superconducting vs. Semiconducting Memory Scaling Comparison", weight="bold", y=0.96)

# Plot 1: Capacity
draw_extruded_barh(
    axs[1], tech_cap, cap_vals, cap_colors, cap_labels,
...
# Plot 2: Density
draw_extruded_barh(
    axs[0], tech_den, den_vals, den_colors, den_labels,
