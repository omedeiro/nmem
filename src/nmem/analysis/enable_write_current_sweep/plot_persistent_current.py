...
def main(
    data_dir="data", mat_files=None, persistent_current=75, critical_current_zero=1250
):
    """
    ...
    if mat_files is None:
        mat_files = [
            sio.loadmat("measured_state_currents_290.mat"),
            sio.loadmat("measured_state_currents_300.mat"),
            sio.loadmat("measured_state_currents_310.mat"),
        ]
