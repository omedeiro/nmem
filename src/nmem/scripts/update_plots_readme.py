...
def create_plots_readme(plots_dir, style_mode="paper"):
    ...
    scripts_dir = plots_dir.parent / "scripts"  # plots is in src/nmem/plots, scripts is in src/nmem/scripts
    ...
    with open(readme_path, 'w', encoding='utf-8') as f:
        ...
        f.write("This directory contains plots generated by the nmem project plotting scripts.\n\n")
        ...
        f.write("```\n\n")
        f.write("**Individual plots:** Run the corresponding script in `src/nmem/scripts/`\n")
    
    logger.info(f"Created {readme_path}")
    logger.info(f"Documented {len(png_files)} plots organized into {len(script_groups)} script groups")
